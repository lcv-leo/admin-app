...
var DEFAULT_MODEL, GEMINI_CONFIG, onRequestPost;
...
var DEFAULT_MODEL2, onRequestGet4;
var init_health = __esm({
  "api/ai-status/health.ts"() {
    ...
    init_mainsite_admin();
    DEFAULT_MODEL2 = "";
    __name(resolveModel2, "resolveModel");
    __name(json2, "json");
...
var onRequestGet6, onRequestPost5;
...
var parseLimit, toHeaders3, toSyncRow;
var init_sync = __esm({
  "api/astrologo/sync.ts"() {
    "use strict";
    init_functionsRoutes_0_2581705233114575();
...
var onRequestGet10, onRequestDelete;
...
var toHeaders5, toError2, toPositiveInt;
...
var toHeaders6, toError3, normalizeRecord;
...
var resolveToken2, parseJsonOrThrow2, toFirstError2, cloudflareRequest2, validateCloudflareApiPath, parseJsonSafe, normalizeAccount, listCloudflareAccounts, resolveCloudflarePwAccount, listCloudflareWorkers, getCloudflareWorker, listCloudflareWorkerDeployments, deleteCloudflareWorker, listCloudflarePagesProjects, getCloudflarePagesProject, listCloudflarePagesDeployments, deleteCloudflarePagesProject, deleteCloudflarePagesDeployment, getCloudflareWorkerSchedules, updateCloudflareWorkerSchedules, getCloudflareWorkerUsageModel, updateCloudflareWorkerUsageModel, listCloudflareWorkerSecrets, addCloudflareWorkerSecret, deleteCloudflareWorkerSecret, listCloudflarePagesDomains, addCloudflarePagesDomain, deleteCloudflarePagesDomain, getCloudflarePagesDeployment, isDirectUploadLikeTrigger, retryCloudflarePagesDeployment, rollbackCloudflarePagesDeployment, getCloudflarePagesDeploymentLogs, createCloudflarePagesProject, updateCloudflarePagesProjectSettings, listCloudflareWorkerVersions, listCloudflareWorkerRoutes, addCloudflareWorkerRoute, deleteCloudflareWorkerRoute, runCloudflareRawRequest, listCloudflareZones2, purgeCloudflareZoneCache;
var init_cfpw_api = __esm({
  "api/_lib/cfpw-api.ts"() {
    ...
    cloudflareRequest2 = /* @__PURE__ */ __name(async (env2, path, fallback, init, overrideToken) => {
    ...
    getCloudflarePagesDeployment = /* @__PURE__ */ __name(async (env2, accountId, projectName, deploymentId) => {
      const normalizedAccountId = accountId.trim();
      const normalizedProject = projectName.trim();
      const normalizedDeploymentId = deploymentId.trim();
      if (!normalizedAccountId || !normalizedProject || !normalizedDeploymentId) {
    ...
    isDirectUploadLikeTrigger = /* @__PURE__ */ __name((triggerType) => {
    ...
    listCloudflareZones2 = /* @__PURE__ */ __name(async (env2) => {
    ...
    purgeCloudflareZoneCache = /* @__PURE__ */ __name(async (env2, zoneId, options) => {
      const normalizedZoneId = zoneId.trim();
      if (!normalizedZoneId) {
...
var jsonResponse3, isActiveStageStatus, TARGET_BRANCHES, getDeploymentBranch, isInCleanupScope, isPreviewDeployment, resolveMainActiveIds;
...
var toHeaders8, toError5, toText;
...
var toHeaders9, toError6, toText2;
...
var toHeaders10, toError7, toText3, normalizeSchedules, resolveOpsErrorStatus;
var init_ops = __esm({
  "api/cfpw/ops.ts"() {
    "use strict";
    init_functionsRoutes_0_2581705233114575();
    ...
    resolveOpsErrorStatus = /* @__PURE__ */ __name((message) => {
...
var toHeaders11, toError8, mapWorker, mapProject;
...
var toHeaders12, toError9, toProjectName;
...
var toHeaders13, toError10, toScriptName;
...
var FINANCIAL_CUTOFF_BRT, FINANCIAL_CUTOFF_DATE, FINANCIAL_CUTOFF_UTC, FINANCIAL_CUTOFF_ISO, getStartIsoWithCutoff, isOnOrAfterCutoff, onRequestGet17;
...
var FINANCIAL_CUTOFF, onRequestGet18;
...
var import_mercadopago, onRequestPost16;
...
var import_mercadopago2, onRequestPost17;
...
var FINANCIAL_CUTOFF2, onRequestGet19;
...
var init_sumup_refund = __esm({
  "api/financeiro/sumup-refund.ts"() {
    ...
    init_performance2();
    init_dist();
    onRequestPost19 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
      const id = url.searchParams.get("id");
      if (!id) return Response.json({ success: false, error: "ID do pagamento ausente." }, { status: 400 });
      const token = context2.env.SUMUP_API_KEY_PRIVATE;
...
var DEFAULT_PARAMS, SUPPORTED_ROUTES, toHeaders14, toRate, validateRate, ensureParametrosTables, readLatestParams;
...
var json10, resolveParametrosDb, resolveOperationalSource3;
var init_parametros = __esm({
  "api/calculadora/parametros.ts"() {
    ...
    init_admin_actor();
    init_request_trace();
    json10 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
      status,
      headers: toHeaders14()
    }), "json");
...
var parseLimit2, toHeaders15, parseObservabilidadeRows, parseRateLimitPolicies, existsObservabilidade;
...
var init_marked_esm = __esm({
  "../node_modules/marked/lib/marked.esm.js"() {
    ...
    T = M();
    __name(G, "G");
    _ = { exec: /* @__PURE__ */ __name(() => null, "exec") };
    __name(k, "k");
    be = (() => {
      try {
    ...
    tt = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
    ke = /* @__PURE__ */ __name((u3) => tt[u3], "ke");
    __name(O, "O");
    __name(J, "J");
    __name(V, "V");
    __name(I, "I");
...
var GEMINI_CONFIG2, FALLBACK_MODEL, JINA_READER_PREFIX, JINA_TIMEOUT_MS, GEMINI_SHARE_RE, onRequestPost23, onRequestOptions;
var init_gemini_import = __esm({
  "api/mainsite/gemini-import.ts"() {
    ...
    __name(resolveModel3, "resolveModel");
    JINA_READER_PREFIX = "https://r.jina.ai/";
    JINA_TIMEOUT_MS = 15e3;
    __name(fetchSharePageContent, "fetchSharePageContent");
    __name(structuredLog2, "structuredLog");
    __name(logAiUsage2, "logAiUsage");
    ...
    onRequestPost23 = /* @__PURE__ */ __name(async (context2) => {
      const corsHeaders = {
...
var EXTERNAL_MEDIA_PATTERN, INTERNAL_MEDIA_PREFIX, onRequestPost24;
var init_migrate_media_urls = __esm({
  "api/mainsite/migrate-media-urls.ts"() {
    ...
    onRequestPost24 = /* @__PURE__ */ __name(async (context2) => {
      const db = context2.env.BIGDATA_DB;
      if (!db) {
...
var DEFAULT_GEMINI_MODEL, SUMMARY_SAFETY_SETTINGS, json12;
var init_post_summaries = __esm({
  "api/mainsite/post-summaries.ts"() {
    ...
    json12 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), { status, headers: toHeaders() }), "json");
...
var init_upload = __esm({
  "api/mainsite/upload.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    onRequestPost30 = /* @__PURE__ */ __name(async (context2) => {
      try {
...
var FALLBACK_MODEL2, DIRECTORY, onRequestGet32;
var init_discover = __esm({
  "api/news/discover.ts"() {
    ...
    __name(resolveModel4, "resolveModel");
    DIRECTORY = [
      // Brasil — Geral
    ...
    onRequestGet32 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
...
var RSS_SOURCES, DEFAULT_MAX_ITEMS, CACHE_TTL_SECONDS, onRequestGet33;
var init_feed = __esm({
  "api/news/feed.ts"() {
    "use strict";
    init_functionsRoutes_0_2581705233114575();
    ...
    onRequestGet33 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
...
var onRequestGet34, onRequestPut5;
var init_cron = __esm({
  "api/oraculo/cron.ts"() {
    "use strict";
    init_functionsRoutes_0_2581705233114575();
    ...
    onRequestGet34 = /* @__PURE__ */ __name(async ({ env: env2 }) => {
...
var init_excluir2 = __esm({
  "api/oraculo/excluir.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    onRequestPost33 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
...
var init_modelos4 = __esm({
  "api/oraculo/modelos.ts"() {
    ...
    onRequestGet36 = /* @__PURE__ */ __name(async ({ env: env2 }) => {
      const apiKey = env2?.GEMINI_API_KEY;
...
var init_taxacache = __esm({
  "api/oraculo/taxacache.ts"() {
    ...
    onRequestGet37 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
      const db = env2?.BIGDATA_DB;
      if (!db || typeof db.prepare !== "function")
...
var onRequestGet38, onRequestDelete4;
...
// ../.wrangler/tmp/bundle-cq43Ug/middleware-loader.entry.ts
init_functionsRoutes_0_2581705233114575();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-cq43Ug/middleware-insertion-facade.js
init_functionsRoutes_0_2581705233114575();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.26714217397514317.mjs.map
