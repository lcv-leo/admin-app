...
- Convenção de rastreabilidade de resposta: endpoints administrativos retornam `request_id` e `timestamp` para correlação de logs/incidentes em suporte operacional.
