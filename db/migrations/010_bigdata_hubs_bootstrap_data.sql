...
VALUES
  ...
  (4, 3, 'Calculadora Itaú', 'Simulador para operações financeiras Itaú.', 'https://calculadora-itau.lcv.app.br/', '🧮', 'Abrir App', 1711270400000, 'bootstrap@bigdata-hubs');
...
VALUES
  ...
  (5, 4, 'Itaú Calculadora Admin', 'Painel administrativo da calculadora de câmbio com controle operacional.', 'https://admin-itau.lcv.app.br', '🏦', 'Autenticar', 1711270400000, 'bootstrap@bigdata-hubs');
