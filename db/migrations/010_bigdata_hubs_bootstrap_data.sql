...
VALUES
  ...
  (4, 3, 'Calculadora Financeira', 'Simulador para operações financeiras.', 'https://calculadora-calculadora.lcv.app.br/', '🧮', 'Abrir App', 1711270400000, 'bootstrap@bigdata-hubs');
...
VALUES
  ...
  (5, 4, 'Calculadora Financeira Admin', 'Painel administrativo da calculadora de câmbio com controle operacional.', 'https://admin-calculadora.lcv.app.br', '🏦', 'Autenticar', 1711270400000, 'bootstrap@bigdata-hubs');
